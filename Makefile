...
#########################################################################################
rocksdb: 3rd-party/rocksdb/java/target/rocksdbjni-6.15.5-linux64.jar
...
3rd-party/rocksdb/db/db_impl/db_impl_open.cc.orig: 3rd-party/rocksdb/.dir_ok 3rd-party/rocksdb/.dir_ok rocksdb_patches/thread_report.patch
	$(info Executing target $@)
...
3rd-party/rocksdb/java/target/rocksdbjni-6.15.5-linux64.jar: $(ROCKSDB_DEPS)
	cd 3rd-party/rocksdb && make DEBUG_LEVEL=0 EXTRA_LDFLAGS=$(ROCKSDB_EXTRA_LDFLAGS) -j4 db_bench rocksdbjava
...
ifndef ROCKSDB_PREFIX
	...
	cd 3rd-party/rocksdb && make DEBUG_LEVEL=0 EXTRA_LDFLAGS=$(ROCKSDB_EXTRA_LDFLAGS) PREFIX=$(ROCKSDB_PREFIX) -j4 install
